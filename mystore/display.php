...
.image {
  background-image: url('Sports3.jpeg');
  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="output.php"><span class="glyphicon glyphicon-log-out"></span><u>Logout</u></a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" class="image"> 
	<br><br>
	<?php
	...
	if(mysqli_num_rows($result)>0){
		echo "<table border='2' align='center'><tr><th>Product Id</th><th>Product name</th><th>Company name</th><th>Product prise</th><th>Offers</th><th>Num of products availble</th></tr>";
